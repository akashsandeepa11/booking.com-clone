...
const PlacesScreen = () => {
      ...
      properties: [
        {
          ...
          oldPrice: 4600,
          newPrice: 3312,
          coordinate: { latitude: 13.0359, longitude: 77.6431 },
        ...
        },
        {
          ...
          oldPrice: 3800,
          newPrice: 3078,
          coordinate: { latitude: 13.1989, longitude: 77.7068 },
    ...
    },
    {
      ...
      properties: [
        ...
        },
        {
          ...
          oldPrice: 5200,
          newPrice: 4100,
          coordinate: { latitude: 12.0359, longitude: 77.1431 },
          photos: [
            {
              id: "160",
              image:
  ...
  return (
    <View>
      <StatusBar />
      <Pressable className=" flex-row items-center justify-between p-2 bg-white px-5">
        <Pressable
          onPress={() => setModalVisible(!modalVisible)}
          className=" flex-row items-center"
        >
          <Octicons name="arrow-switch" size={22} color="gray" />
          <Text className=" text-[15] m-2 font-medium">Sort</Text>
        </Pressable>
        <Pressable className=" flex-row items-center">
          <Ionicons name="filter" size={22} color="gray" />
          <Text className=" text-[15] m-2 font-medium">Filter</Text>
        </Pressable>
        <Pressable
          onPress={() => {
            navigation.navigate("Map", { searchPlaces });
          }}
          className=" flex-row items-center"
        >
          <FontAwesome5 name="map-marker-alt" size={22} color="gray" />
          <Text className=" text-[15] m-2 font-medium">Map</Text>
        </Pressable>
      </Pressable>
      ...
      >
        <ModalContent className="w-screen h-[280]">
          <View className="flex-row">
            <View className="my-3 flex-[2] h-[280] border-r-[1px] border-[#E0E0E0]">
              <Text className="text-center">Sort</Text>
            </View>
            <View className="flex-[3] m-2">
